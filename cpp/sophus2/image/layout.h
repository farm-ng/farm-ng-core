...
#include "sophus2/concepts/image.h"
...
class ImageLayout {
 public:
  ...
  template <class TPixelFormat>
  [[nodiscard]] static auto makeFromSize(sophus2::ImageSize image_size)
      -> ImageLayout {
 ...
 private:
  sophus2::ImageSize image_size_ = {0, 0};
...
template <>
struct fmt::formatter<sophus2::ImageLayout> : ostream_formatter {};
