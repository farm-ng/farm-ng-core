...
#define FARM_ENUM_IOSTREAM_OVERLOAD(EnumName)                      \
  ...
  [[maybe_unused]] inline auto operator<<(                         \
      std::ostream &os, EnumName##Impl value) -> std::ostream & {  \
    os << toPretty(value);                                         \
    return os;                                                     \
  }                                                                \
  [[maybe_unused]] inline auto operator>>(                         \
      std::istream &is, EnumName##Impl &value) -> std::istream & { \
    std::string str;                                               \
    is >> str;                                                     \
    ...
    return is;                                                     \
                                                                   ...
                                                                   \
  [[maybe_unused]] inline auto format_as(EnumName##Impl value) {   \
