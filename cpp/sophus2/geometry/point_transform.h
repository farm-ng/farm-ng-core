...
#include "sophus2/geometry/inverse_depth.h"
...
class PointTransformer {
 public:
  ...
  explicit PointTransformer(sophus2::Isometry3<TT> const& foo_from_bar)
  ...
  [[nodiscard]] auto fooFromBar() const -> sophus2::Isometry3<TT> const& {
 ...
 private:
  sophus2::Isometry3<TT> foo_from_bar_;
