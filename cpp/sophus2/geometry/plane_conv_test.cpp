...
#include "sophus2/geometry/plane_conv.h"
...
auto test2dGeometry() -> bool {
  ...
  for (int i = 0; i < 20; ++i) {
    ...
    sophus2::Rotation2<TScalar> foo_rotation_plane =
  ...
  for (int i = 0; i < 20; ++i) {
    ...
    sophus2::Isometry2<TScalar> foo_from_plane = isometryFromLine(line_in_foo);
...
auto test3dGeometry() -> bool {
  ...
  for (int i = 0; i < 20; ++i) {
    ...
    sophus2::Rotation3<TScalar> foo_rotation_plane =
  ...
  for (int i = 0; i < 20; ++i) {
    ...
    sophus2::Isometry3<TScalar> foo_from_plane =
        isometryFromPlane(plane_in_foo);
