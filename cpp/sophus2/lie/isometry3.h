...
#include "sophus2/lie/impl/rotation3.h"
#include "sophus2/lie/impl/translation_factor_group_product.h"
...
namespace details {
template <class TT>
class Cast<sophus2::Isometry3<TT>> {
 public:
  template <class TTo>
  static auto impl(sophus2::Isometry3<TT> const& v) {
    return v.template cast<typename TTo::Scalar>();
  }
  template <class TTo>
  static auto implScalar(sophus2::Isometry3<TT> const& v) {
