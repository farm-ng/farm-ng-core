...
/* FARM_ENUMFLAGS_WITHOUT_OSTREAM_DEF(NAME, UINT_TYPE, ARGS)
...
/* FARM_ENUMFLAGS_ALIAS(NAME)
  ...
  Enum type alias. Can be in any scope. See FARM_ENUMFLAGS_WITHOUT_OSTREAM for
  details. */
#define FARM_ENUMFLAGS_ALIAS(NAME) using NAME = enum_wrapper_::NAME##Impl

/* FARM_ENUMFLAGS_WITHOUT_OSTREAM(NAME, UINT_TYPE, ARGS)
