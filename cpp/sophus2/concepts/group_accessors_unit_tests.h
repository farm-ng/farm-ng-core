...
void runRotationAccessorTests() {
  ...
  if constexpr (TGroup::kPointDim == 2) {
    auto kElems = sophus2::Rotation2<Scalar>::elementExamples();
    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Rotation2<Scalar> rot = SOPHUS_AT(kElems, g_id);
    ...
    auto kElems = sophus2::Rotation3<Scalar>::elementExamples();

    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Rotation3<Scalar> rot = SOPHUS_AT(kElems, g_id);
...
void runIsometryAccessorTests() {
  using Scalar = typename TGroup::Scalar;
  if constexpr (TGroup::kPointDim == 2) {
    auto kElems = sophus2::Isometry2<Scalar>::elementExamples();
    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Isometry2<Scalar> iso = SOPHUS_AT(kElems, g_id);
    ...
    auto kElems = sophus2::Isometry3<Scalar>::elementExamples();

    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Isometry3<Scalar> iso = SOPHUS_AT(kElems, g_id);
...
void runSpiralSimilarityAccessorTests() {
  ...
  if constexpr (TGroup::kPointDim == 2) {
    auto kElems = sophus2::SpiralSimilarity2<Scalar>::elementExamples();
    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::SpiralSimilarity2<Scalar> spiral_sim = SOPHUS_AT(kElems, g_id);
    ...
    auto kElems = sophus2::SpiralSimilarity3<Scalar>::elementExamples();

    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::SpiralSimilarity3<Scalar> spiral_sim = SOPHUS_AT(kElems, g_id);
      double scale = spiral_sim.scale();
...
void runSimilarityAccessorTests() {
  ...
  if constexpr (TGroup::kPointDim == 2) {
    auto kElems = sophus2::Similarity2<Scalar>::elementExamples();
    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Similarity2<Scalar> sim = SOPHUS_AT(kElems, g_id);
    ...
    auto kElems = sophus2::Similarity3<Scalar>::elementExamples();

    for (size_t g_id = 0; g_id < kElems.size(); ++g_id) {
      sophus2::Similarity3<Scalar> sim = SOPHUS_AT(kElems, g_id);
      double scale = sim.scale();
