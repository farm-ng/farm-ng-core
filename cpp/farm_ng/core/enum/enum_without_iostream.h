...
///  Enum type alias. Can be in any scope. See FARM_ENUM_WITHOUT_IOSTREAM below
///  for details.
...
///
///  For example ``FARM_ENUM_WITHOUT_IOSTREAM(FooBar, int, (foo, bar));``
...
///
///    // Sets enum given corresponding string, if string is valid (i.e. "foo"
///    or
...
///    }
///
///    // Return string views of enum type. First argument is needed for ADL
///    only. std::array<string_view, 2> getStrings(FooBar) {
///      return {"foo", "bar"};
///    }
///
...
///    }
///
///    // Returns the position of enum value in the enum class. This is the
///    inverse
...
///    }
///
///    // Return string representation of type name. First argument is needed
///    for
///    // ADL only.
