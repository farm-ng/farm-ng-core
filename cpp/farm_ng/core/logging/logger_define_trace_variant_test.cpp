...
TEST(logger, compile_time_trace_runtime_info) {  // NOLINT
...
TEST(logger, compile_time_trace_runtime_debug) {  // NOLINT
  CaptureStdErr capture;
  auto const orig_log_level = defaultLogger().getLogLevel();
...
TEST(logger, compile_time_trace_runtime_trace) {  // NOLINT
  CaptureStdErr capture;
  auto const orig_log_level = defaultLogger().getLogLevel();
